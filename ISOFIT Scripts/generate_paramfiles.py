def gen_geompar(filepath,x0=1024,y0=1024,ellip0=0.2,pa0=0,sma0=10,minsma=0,maxsma=700,step=0.1,linear="no",maxrit="INDEF",recenter="yes",xylearn="yes",physical="yes"):
    ...
    file.write("sma0,r,h," + str(sma0) + ",5.,,\"initial semi-major axis lenght\"\n")
    file.write("minsma,r,h," + str(minsma) + ",0.,,\"minimum semi-major axis lenght\"\n")
    file.write("maxsma,r,h," + str(maxsma) + ",1.,,\"maximum semi-major axis lenght\"\n")
    file.write("step,r,h," + str(step) + ",0.001,,\"sma step between successive ellipses\"\n")
    file.write("linear,b,h," + str(linear) + ",,,\"linear sma step ?\"\n")
    file.write("maxrit,r,h," + str(maxrit) + ",0.,,\"maximum sma lenght for iterative mode\"\n")
...
sma0,r,h,10.,5.,,"initial semi-major axis lenght"
minsma,r,h,0.,0.,,"minimum semi-major axis lenght"
maxsma,r,h,700.,1.,,"maximum semi-major axis lenght"
step,r,h,0.1,0.001,,"sma step between successive ellipses"
linear,b,h,no,,,"linear sma step ?"
maxrit,r,h,INDEF,0.,,"maximum sma lenght for iterative mode"
